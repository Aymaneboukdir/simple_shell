...
/**
 * is_chain - test if current char in bufferr is  chain delimeter
 * @info: the parameter structtt
 * @buf: char bufferr
 * @p: addresss of currentt position in buf
 *
 ...
 * @buf:  char buffer
 * @p: address of current position in bufff
 * @i: starting position in bufff
 * @len: length of bufff
 *
 * Return: Void
 */
